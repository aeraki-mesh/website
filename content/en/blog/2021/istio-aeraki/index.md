...
To address these problems, we create an open-source project, [Aeraki](https://github.com/aeraki-mesh), to provide a non-intrusive, extendable way to manage any layer-7 traffic in an Istio service mesh.
